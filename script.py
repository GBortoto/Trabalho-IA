...
class KMeansPlotter():
    ...
    def createPlotPoints(self, kmeans):
        ...
        clusters = centroid_labels
        print(kmeans.lista_centroid_mais_proximos)
        clusters.extend(kmeans.lista_centroid_mais_proximos)
        ...
        for point in range(0 ,dados2d.shape[0]):
            #pontos
            if(clusters[point] >= 0):
                pl.scatter(dados2d[point,0],dados2d[point,1],c='r',marker=self.markers[point%24])
            #centroids
            elif(clusters[point] < 0):
                pl.scatter(dados2d[point,0],dados2d[point,1] , s = area , c ='r' , alpha=0.5)
